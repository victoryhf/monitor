...
def ip_tais_t():
   #return render_template('./cps/ip_tais_t.html', tais=getNodeData('tais', 'T'), ctais=getNodeCapacity('tais', 'T'))
    return render_template('./cps/ip_tais_t.html', tais=getNodeData('tais', 'T') + getNodeCapacity('tais', 'T'))
...
#增加tais容量监控by hf 2016.7.13 17:03
#@app.route('/cps/c_ip_tais_t.html', methods=['GET'])
#def capacity_ip_tais_t():
   # return render_template('./cps/ip_tais_t.html', tais=getNodeCapacity('tais', 'T'))

#@app.route('/cps/ip_tais_t.html', methods=['GET'])
#def capacity_ip_tais_a():
#    return render_template('./cps/ip_tais_a.html', tais=getNodeCapacity('tais', 'A'))

#@app.route('/cps/ip_tais_t.html', methods=['GET'])
#def capacity_ip_tais_b():
#    return render_template('./cps/ip_tais_b.html', tais=getNodeCapacity('tais', 'B'))
