...
def getNodeCapacity(node,unit):
    '''根据节点及机组生成关键字字典，返回列表，监控容量'''
...
if __name__ == '__main__':
    ...
    print getNodeCapacity('tais','t')
    print(222222222222222)
    print getNodeData('tais','t')
